...
class SafePlaceEnvNNPyPy(SafePlaceEnv):
    ...
    """
    def __init__(self, weights_pickle_path: str) -> None:
        """
        Method called after the creation of the object. It prints some info to terminal and loads the neural network
        weights.
        Args:
            weights_pickle_path: location of the weights file in the file system.
        """
    ...
    def update_nn(self, weights_pickle_path: str) -> None:
        """
        Updates the neural network weights from a file in the file system.
        Args:
            weights_pickle_path: location of the weights file in the file system.
        """
        with open(weights_pickle_path, 'rb') as f:
